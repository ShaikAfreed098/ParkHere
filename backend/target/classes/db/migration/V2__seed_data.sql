...
(1, 'ParkHere Banjara Hills', 'Road No. 1, Banjara Hills, Near GVK One Mall, Hyderabad, Telangana', 17.4192, 78.4484, '0.3 km', 'Premium multi-level parking lot located in the heart of Banjara Hills. Offering high-speed EV chargers and top-tier security.', 0.0, 0, 'https://images.unsplash.com/photo-1506521781263-d8422e82f27a?w=800&h=400&fit=crop&auto=format', ARRAY['ev', 'covered', 'security', 'wifi'], '00:00 - 24:00'),
(2, 'ParkHere MG Road', 'MG Road, Near Trinity Metro Station, Bengaluru, Karnataka', 12.9738, 77.6119, '0.7 km', 'Spacious parking layout near commercial complexes and metro on MG Road. Affordable and convenient.', 0.0, 0, 'https://images.unsplash.com/photo-1573348722427-f1d6819fdf98?w=800&h=400&fit=crop&auto=format', ARRAY['covered', 'security'], '06:00 - 23:00'),
(3, 'ParkHere Whitefield', 'ITPB Road, Opposite Manyata Tech Park Area, Bengaluru, Karnataka', 12.9698, 77.7499, '1.2 km', 'Smart open-air parking facility with real-time slot checking and multiple high-output EV charging stations.', 0.0, 0, 'https://images.unsplash.com/photo-1590674899484-d5640e854abe?w=800&h=400&fit=crop&auto=format', ARRAY['ev', 'security', 'wifi'], '00:00 - 24:00'),
(4, 'ParkHere Connaught Place', 'Radial Road 3, Connaught Place, Block E, New Delhi, Delhi', 28.6304, 77.2177, '1.8 km', 'Premium underground automated parking in Connaught Place. Fully covered with absolute safety guards and valet assistance.', 0.0, 0, 'https://images.unsplash.com/photo-1568605114967-8130f3a36994?w=800&h=400&fit=crop&auto=format', ARRAY['ev', 'covered', 'security', 'wifi', 'accessible'], '00:00 - 24:00'),
(5, 'ParkHere Bandra West', 'Linking Road, Near National College, Bandra West, Mumbai, Maharashtra', 19.0607, 72.8362, '0.5 km', 'Sleek multi-level garage in Mumbais commercial high street. Direct access to shops and food junctions.', 0.0, 0, 'https://images.unsplash.com/photo-1553729459-efe14ef6055d?w=800&h=400&fit=crop&auto=format', ARRAY['covered', 'security', 'wifi'], '08:00 - 23:30'),
(6, 'ParkHere Hitech City', 'Madhapur Main Road, Near Mindspace IT Park, Hyderabad, Telangana', 17.4435, 78.3772, '2.1 km', 'State-of-the-art smart parking next to Hitech Citys major tech parks. Multi-story automated layout with wheelchair access.', 0.0, 0, 'https://images.unsplash.com/photo-1542281286-9e0a16bb7366?w=800&h=400&fit=crop&auto=format', ARRAY['ev', 'covered', 'security', 'wifi', 'accessible'], '00:00 - 24:00');
...
-- 10. Seed Notifications (Removed for fresh start)

-- 11. Seed Reviews (Removed for fresh start)
